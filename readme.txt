...
Tags: foursquare, hotels, reviews, ratings, recommendations
...
Plugin Name: Widgets for Foursquare Reviews
Plugin Title: Widgets for Foursquare Reviews Plugin
Plugin URI: https://wordpress.org/plugins/review-widgets-for-foursquare/
Author: Trustindex.io <support@trustindex.io>
Author URI: https://www.trustindex.io/
Text Domain: review-widgets-for-foursquare
Version: 12.4.1
...
Display your **Foursquare reviews** for free with our responsive widgets in 2 minutes.

[vimeo https://player.vimeo.com/video/506438055]

The plugin displays your **Foursquare reviews** in amazing predesigned widgets. You can simply create and display your own widgets, and filter your reviews to build customers' trust and increase SEO.

### Free plugin features

* Free usage
* Display up to 10 Foursquare reviews
* 40+ Widget layouts
...
[Create a Free Account for More Features](https://www.trustindex.io/ti-redirect.php?a=sys-wp&c=foursquare.php-r1)
...
[Create a Free Account for More Features](https://www.trustindex.io/ti-redirect.php?a=sys-wp&c=foursquare.php-r2)
...
Our Widgets for Foursquare Reviews supports the following languages:
...
If you have any issues at all setting up the Foursquare reviews WordPress Plugin for your business, you can contact our customer support team in various ways.

We offer 24/7 email support in English.

We recommend the following order when searching for answers:
1. Plugin FAQ here at the bottom - if you don’t already know why it’s worth displaying Foursquare reviews
...
4. Check topics or ask a new question here: [Support Forum](https://wordpress.org/support/plugin/review-widgets-for-foursquare/)
...
This FAQ is for you if you do not already know why it’s worth displaying Foursquare reviews.
...
= I don’t have any Foursquare reviews yet, what can I do? =
...
= Why Foursquare reviews are better than a simple review collected by myself? =

Reviews collected by Foursquare are much more reliable than feedbacks from a private uncontrollable source. You can increase SEO, trust and sales using Foursquare reviews.
