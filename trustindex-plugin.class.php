<?php
class TrustindexPlugin_foursquare
{
...
$chosedPlatform = new $className($forcePlatform, $filePath, "do-not-care-12.4.1", "do-not-care-Widgets for Foursquare Reviews", "do-not-care-Foursquare");
